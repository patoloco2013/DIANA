...
final class Database
{
    ...
    public static function pdo(): PDO
    {
        if (self::$pdo === null) {
            ...
            // CURDATE()/NOW() se combinan en consultas con fechas calculadas en
            // PHP; si el servidor MySQL corre en UTC divergirían cerca de la
            // medianoche. date('P') ya contempla el horario de verano.
