...
-- ---------------------------------------------------------------------
-- Archivos adjuntos del evento (convocatoria, programa, presentaciones...).
-- A diferencia de evento_imagenes, no son una galería: cualquier documento
-- de referencia del evento, varios por evento y de varios tipos.
-- ---------------------------------------------------------------------
CREATE TABLE evento_documentos (
    id              INT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
    colegio_id      INT UNSIGNED NOT NULL,
    evento_id       INT UNSIGNED NOT NULL,
    tipo            VARCHAR(30)  NOT NULL,             -- clave de Catalogos::TIPOS_DOCUMENTO_EVENTO
    descripcion     VARCHAR(150) NULL,
    archivo         VARCHAR(255) NOT NULL,             -- ruta relativa en storage/uploads
    nombre_original VARCHAR(150) NOT NULL,
    mime            VARCHAR(80)  NOT NULL,
